...
const PREFERENCES = [
  {
    ...
    description:
      "Shuttle services, taxi access, near attractions or comfortable transport options.",
  },
  {
    id: "room",
    icon: "🛏️",
    title: "Room Comfort",
    description: "Walk-in showers, pillow choices or accessible power outlets.",
  },
  {
    id: "conveniences",
    icon: "🏪",
    title: "Onsite Conveniences",
    description: "Stores, medical services, or an ATM close by.",
  },
  {
    id: "dining",
    icon: "🍽️",
    title: "Dining Flexibility",
    description:
      "Meal options for specific diet needs or cafes and restaurants nearby.",
  },
  {
    id: "safety",
    icon: "🛡️",
    ...
    description:
      "Good lighting, a doctor on call, anti-slip flooring or walk-in shower.",
  },
  {
    id: "assistance",
    icon: "🤝",
    ...
    description:
      "Friendly staff for luggage help, valet parking, or on-site assistance.",
  },
  {
    id: "wellness",
    icon: "🧘",
    title: "Wellness & Leisure",
    description: "Access to spas, yoga sessions, or fitness facilities.",
  },
  {
    id: "access",
    icon: "♿",
    ...
    description:
      "Fewer stairs, elevators, ramps, or buggy services for easy movement.",
  },
  {
    id: "quiet",
    icon: "🔇",
    title: "Quiet & Relaxing",
    description: "Quiet areas, soundproof rooms, or adult-only spaces.",
  },
];
        ...
        <div className="flex flex-col items-center gap-3">
          {!canContinue && (
            <p className="text-sm text-gray-400">
              Select {remaining} more preference{remaining !== 1 ? "s" : ""} to
              continue
            </p>
          )}
          <button
            ...
            style={{
              background: canContinue && !saving ? "#1D9E75" : "#d1d5db",
